 ...
 */
public class RecycleOrderAdapater extends RecyclerView.Adapter<OrderHolder>{
    List<APIOrder.ResponBean> listGuru;
    private Context context;
    private String notlp1,email,tgllahir,tempatlahir,jeniskelamin,namabelakang;

    public RecycleOrderAdapater(Context context, List<APIOrder.ResponBean> listGuru) {
    ...
    public void onBindViewHolder(OrderHolder holder, int position) {
        final APIOrder.ResponBean guru = listGuru.get(position);
